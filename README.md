...
| ---- | ----------- | ---- | -------- | ------ | ---- | --- |
| [Original](https://aminet.net/package/dev/lang/brainfuck-2) | | Interpreter | C | Urban Müller | 1993 | `original` |
...
| [bf-li](http://lvogel.free.fr/bf.html) | Fast brainfuck interpreter using GNU lightning | JIT Compiler | C | Laurent Vogel | 2011 | `bf-li` |
